    ...
    */
    ...
    public SwerveDrivetrain() {
        fl = new SwerveModule(
            ...
            DeviceIDs.STEER_FL, false, 
            DeviceIDs.ENCODER_FL_0, DeviceIDs.ENCODER_FL_1, 0.0, false, 
            DrivebaseConstants.FRONT_LEFT);
        
        fr = new SwerveModule(
            DeviceIDs.DRIVE_FR, false, 
            DeviceIDs.STEER_FR, false, 
            DeviceIDs.ENCODER_FR_0, DeviceIDs.ENCODER_FR_1, 0.0, false, 
            DrivebaseConstants.FRONT_RIGHT);

        bl = new SwerveModule(
            DeviceIDs.DRIVE_BL, false, 
            DeviceIDs.STEER_BL, false, 
            DeviceIDs.ENCODER_BL_0, DeviceIDs.ENCODER_BL_1, 0.0, true, 
            DrivebaseConstants.BACK_LEFT);

        br = new SwerveModule(
            DeviceIDs.DRIVE_BR, false, 
            DeviceIDs.STEER_BR, false, 
            DeviceIDs.ENCODER_BR_0, DeviceIDs.ENCODER_BR_1, 0.0, true, 
    ...
    public void periodic() {
        ...
        try {
            ...
            SmartDashboard.putNumber("FR steer pos", fr.getSteerPosition());
            SmartDashboard.putNumber("BL steer pos", bl.getSteerPosition());
            SmartDashboard.putNumber("BR steer pos", br.getSteerPosition());
            ...
            SmartDashboard.putNumber("FL heading", fl.getRadians());
            SmartDashboard.putNumber("FR heading", fr.getRadians());
            SmartDashboard.putNumber("BL heading", bl.getRadians());
            SmartDashboard.putNumber("BR heading", br.getRadians());
