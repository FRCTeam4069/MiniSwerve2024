...
import frc.robot.subsystems.ModuleEncoder;

public class SwerveModule {
    private CANSparkMax drive;
    private CANSparkMax steer;
    private ModuleEncoder encoder;
    ...
    public SwerveModule(
        ...
        encoder = new ModuleEncoder(encoderIdA, encoderIdB, encoderInverted);
        ...
        steerPIDController.enableContinuousInput(-Math.PI/2.0, Math.PI/2.0);
     ...
     */
    public void update() {
        heading = encoder.getNormalizedAngle();
    }
    ...
    public double getRadiansNow() {
        heading = Units.degreesToRadians(encoder.getNormalizedAngle());
        return heading;
    }
